...
- 137개 정적 질문과 현재 화면 단위에서는 runtime list virtualization을 도입하지 않는다. Library filtering은 memoization하며 실제 저사양 WebView에서 scroll 성능을 확인한다.
