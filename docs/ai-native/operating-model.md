...
현재 하네스는 39개 전체 질문의 구조, ID, 카테고리 범위, prerequisite 참조와 위험한 markup을 검사한다. 별도의 golden cases는 핵심 주장과 대표 오개념을 development, regression, challenge suite로 나눠 검사한다. 모든 gate는 100% 통과해야 한다.
