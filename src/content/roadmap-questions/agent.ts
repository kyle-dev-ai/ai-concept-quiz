...
export const agentRoadmapQuestions = [
  ...
  },
  {
    ...
    deepAnswer:
      '요약을 요약하는 방식을 반복하면 오류가 누적되고 초기 맥락이 왜곡되는 문제가 생깁니다. 그래서 매번 새로 요약하기보다 이전 요약과 새 대화만으로 갱신하는 방식, 혹은 구간별 요약을 계층으로 쌓아 필요한 구간만 펼치는 방식을 씁니다. 요약 품질은 눈으로만 보지 말고 "요약만 보고 원래 질문에 답할 수 있는가"처럼 과제 기반으로 평가하는 것이 좋습니다.',
    keyPoints: [
