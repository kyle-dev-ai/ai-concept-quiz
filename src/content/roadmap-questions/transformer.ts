...
export const transformerRoadmapQuestions = [
  ...
  },
  {
    ...
    deepAnswer:
      '비중은 사람이 정해주지 않고 학습으로 얻어집니다. 문장마다 봐야 할 곳이 다르므로 이 비중은 매번 새로 계산되고, 그래서 같은 단어라도 문장이 다르면 다르게 해석됩니다. 멀리 떨어진 단어도 한 번에 볼 수 있다는 점이 앞에서부터 차례로 읽는 방식과 가장 크게 다릅니다.',
    keyPoints: ['어디를 얼마나 볼지 비중으로 정한다', '비중은 학습으로 얻고 문장마다 새로 계산'],
  ...
  },
  {
    ...
    keyPoints: ['표현이 단어가 아니라 그 자리에서 만들어진다', '층을 지날수록 문맥이 더 섞인다'],
